---
title: "Microarray Data - Rspondin KI after 2m with infection in stomach corpus - Reanalysis with LIMMA"
...
exp_design = as.data.frame(read_excel("../ExpDesign.xls",sheet = 1), stringsAsFactors=F)
...
exp_design = subset(exp_design, Experiment == "Rspo_KI_vs_WT_2m_infected")
...
#new_anno_file = "/data_genome1/References/MicroArray/Agilent/4x44k_014868_mouse/Agilent_14868_annotations_2017-06-27.Rdata"
...
```{r}
ed=ed_orig
save(ed, RG, MA, file="../../Data/Processed/Corpus_Rspo_KI_2m_with_Hp_micro_array_preprocessed_data.Rdata")
```
