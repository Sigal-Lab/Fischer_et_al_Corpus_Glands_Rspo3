---
title: "Microarray Data - Rspondin KO/KI with or without infection in stomach corpus - Reanalysis with LIMMA"
...
exp_design = subset(exp_design, Tissue == "Stomach Corpus" & grepl("Agilent-014868",Pattern.Name.s.))
...
#  RG =read.maimages(exp_design$FileName[i],source="agilent.median", columns=list(G="gProcessedSignal",R="rProcessedSignal"))
#}
...
```{r}
ed=ed_orig
save(ed, RG, MA,  file="../../Data/Processed/Corpus_Rspo_KI_and_KO_with_or_wo_Hp_micro_array_preprocessed_data.Rdata")
```
